...
public class LogInGUI extends javax.swing.JFrame {
    ...
    private void enterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enterActionPerformed
        ...
        String passwordToLogIn = String.valueOf(password.getPassword());
        ...
        if ((usernameToLogIn.compareTo("") != 0) && (passwordToLogIn.compareTo("") != 0)) {
            ...
            JOptionPane.showConfirmDialog(this, "There is an empty field", "Error message", JOptionPane.ERROR_MESSAGE);
        }
